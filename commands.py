...
def seed_db():
    ...
    db.session.add(freeuser1, freeuser2)
    ...
    db.session.add(paiduser1, paiduser2, paiduser3)
    ...
    db.session.add(comment1, comment2, comment3, comment4, comment5)
    ...
    db.session.add(q_and_a1, q_and_a2, q_and_a3)
    ...
    db.session.add(walkthrough1, walkthrough2, walkthrough3)
    ...
    db.session.add(walkthrough_comment1, walkthrough_comment2, walkthrough_comment3)
    ...
    db.session.add(question1, question2, question3, question4, question5, question6, question7, question8, question9)
    ...
    db.session.add(stored_question1, stored_question2, stored_question3)
